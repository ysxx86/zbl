...
const questions: Question[] = [
  ...
  // Type 3: 图像识别 (Graph)
  { id: 7, type: 'choice', category: '图像识别', difficulty: 1, points: 1, text: "正比例关系的图像是一条什么样的线？", options: [{id:'A', text:'经过原点的直线', isCorrect:true}, {id:'B', text:'弯曲的曲线', isCorrect:false}], explanation: "正比例的图像永远是一条经过原点 (0,0) 的直线！" },
  { id: 8, type: 'choice', category: '图像识别', difficulty: 2, points: 2, text: "如果 y = 5x，那么 y 和 x 成正比例吗？", options: [{id:'A', text:'成正比例', isCorrect:true}, {id:'B', text:'不成正比例', isCorrect:false}], explanation: "成正比例！因为 y ÷ x = 5，比值是固定的常数 5。" },
  { id: 9, type: 'choice', category: '图像识别', difficulty: 3, points: 3, text: "如果 y = x + 5，那么 y 和 x 成正比例吗？", options: [{id:'A', text:'成正比例', isCorrect:false}, {id:'B', text:'不成正比例', isCorrect:true}], explanation: "不成正比例！虽然 x 增加 y 也增加，但 y ÷ x = (x+5)÷x = 1 + 5/x，比值是变化的！它的图像是一条不经过原点的直线。" },

  // Type 4: 生活应用 (Application)
  { id: 10, type: 'choice', category: '生活应用', difficulty: 1, points: 1, text: "速度一定，汽车行驶的【路程】和【时间】成正比例吗？", options: [{id:'A', text:'成正比例', isCorrect:true}, {id:'B', text:'不成正比例', isCorrect:false}], explanation: "成正比例！因为 路程 ÷ 时间 = 速度（一定）。" },
  { id: 11, type: 'choice', category: '生活应用', difficulty: 2, points: 2, text: "总钱数一定，买笔记本的【单价】和【数量】成正比例吗？", options: [{id:'A', text:'成正比例', isCorrect:false}, {id:'B', text:'不成正比例', isCorrect:true}], explanation: "不成正比例！因为 单价 × 数量 = 总钱数（乘积一定），而不是比值一定。这其实是反比例关系哦！" },
  { id: 12, type: 'choice', category: '生活应用', difficulty: 3, points: 3, text: "圆的【面积】和【半径的平方】成正比例吗？", options: [{id:'A', text:'成正比例', isCorrect:true}, {id:'B', text:'不成正比例', isCorrect:false}], explanation: "成正比例！这是一个高级陷阱题。面积 ÷ (半径的平方) = π (圆周率)。因为 π 是一个固定的常数，所以它们成正比例！" }
];

export default function Slide8Quiz() {
